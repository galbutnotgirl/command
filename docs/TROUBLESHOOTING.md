...
| Screenshot -> New conversation shortcut does nothing | Confirm the **Screenshot -> New conversation** combination is bound and enabled in **Settings -> Shortcuts**. Confirm Screen Recording is granted. |
