...
MANDATORY_GATES = {
    ...
    (".github/workflows/test.yml", "python3 ./test/test-suite-inventory.py"),
    (".github/workflows/test.yml", "./test/test-stability-stress.sh"),
    ...
    ("release.sh", 'python3 "${DIR}/test/test-suite-inventory.py"'),
    ("release.sh", '"${DIR}/test/test-stability-stress.sh"'),
